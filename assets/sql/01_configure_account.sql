...
-- セッションのウェアハウスを新しく作成したものに切り替え
-- （teardown 後に旧 WH が残っているとセッション参照が壊れるため）
USE WAREHOUSE DEMO_INTELLIGENCE_WH;

-- データベース作成 → 所有権移譲 → ADMIN ロールでスキーマ作成（権限エラー回避）
